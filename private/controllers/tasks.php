...
class Tasks extends Controller {
    ...
    public function createCommand()
    {
        goat::$app->cleanPage();
        $_bots = null;
        if(isset($_POST['_filters']) && $_POST['_filters'] == 'on' && !empty($_POST['os_version']) && isset($_POST['max_client']) && is_numeric($_POST['max_client']))
        {
            $_filterer = $this->loadModel("bots");
            if(strtolower($_POST['os_version']) == "all operating systems")
            {
