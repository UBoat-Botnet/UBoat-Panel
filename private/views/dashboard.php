...
<script>
    $(function() {
        ...
        var visitorsData = <?= strtoupper($countries) ?>;
        $('#world-map').vectorMap({
            map: 'world_mill_en',
        ...
        var PieData = [
            {
                value: <?= $os_data['Windows Vista'] ?>,
                color: "#f56954",
                highlight: "#f56954",
                label: "Windows Vista"
            },
            {
                value: <?= $os_data['Windows XP'] ?>,
                color: "#00a65a",
                highlight: "#00a65a",
                label: "Windows XP"
            },
            {
                value: <?= $os_data['Windows 7'] ?>,
                color: "#f39c12",
                highlight: "#f39c12",
                label: "Windows 7"
            },
            {
                value: <?= $os_data['Windows 8'] ?>,
                color: "#00c0ef",
                highlight: "#00c0ef",
                label: "Windows 8"
            },
            {
                value: <?= $os_data['Windows 8.1'] ?>,
                color: "#3c8dbc",
                highlight: "#3c8dbc",
                label: "Windows 8.1"
            },
            {
                value: <?= $os_data['Windows 10'] ?>,
                color: "#ff8000",
                highlight: "#ffbf80",
                label: "Windows 10"
            },
